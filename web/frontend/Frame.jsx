...
import {
  ...
  import {ConversationMinor, HomeMajor, SettingsMinor,CustomersMajor,MobileHamburgerMajor,CreditCardMajor,CircleTickMajor, ProfileMajor} from "@shopify/polaris-icons";
      ...
      <Navigation className="sdsd">
        <Navigation.Section
          items={[
            {
              key:1,
              label: (<Link className="sidebar_navigation" to="/"  >Dashboard</Link>),
              icon: HomeMajor,
  
            },
            {    
              key:2,        
              label: (<Link className="sidebar_navigation" to="/components/customers/customers">Customers</Link>),
              icon: CustomersMajor,
            },
            {
              key:3,       
              label: (<Link className="sidebar_navigation"  to="/components/profileSetup/profilesetup">Profile Setup</Link>),         
              icon: ProfileMajor,
            },
            { 
              key:4,       
              label: (<Link className="sidebar_navigation" to="/components/menu-builder/menubuilder">Menu Builder</Link>),           
              icon: MobileHamburgerMajor,
            },
            {
              key:5,       
              label: (<Link className="sidebar_navigation" to="/components/togglefeature"  >Toggle Feature</Link>),           
              icon: CircleTickMajor,
            },
            {
              key:6,       
              label: (<Link className="sidebar_navigation" to="/components/billing/plan" >Plan</Link>),
             
              icon: CreditCardMajor,
            },
            {
              key:7,       
              label: (<Link className="sidebar_navigation" to="/components/setting/setting" >Setting</Link>),           
              icon: SettingsMinor,
            },
          ]}
          action={{
